        ...
        <Reveal delay={0.1}>
          <div className="space-y-6">
            <div className="bg-surface border border-white/10 p-5">
              <p className="text-xs uppercase tracking-widest text-muted">Founded</p>
              <p className="font-display text-3xl">{club.founded}</p>
              <p className="mt-4 text-xs uppercase tracking-widest text-muted">Home ground</p>
              <p className="font-bold">{club.ground}</p>
            </div>
            <div>
              <h3 className="text-sm font-extrabold uppercase tracking-[0.2em] text-muted mb-3">Staff</h3>
