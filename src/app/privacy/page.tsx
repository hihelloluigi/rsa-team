...
// Bump when the text changes in substance: the notice has to say how current it is.
...
export default function PrivacyPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-16">
      <SectionHeading as="h1" label="Le cose serie" title="Informativa privacy" />
      ...
      <LegalSection title="I tuoi diritti">
        <p>
          ...
          <Link href="/contact">Contatti</Link>: rispondiamo entro un mese, di solito molto prima.
        </p>
        <p>
